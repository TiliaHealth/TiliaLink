 ...
 */
export declare function resolveDevicePixelScale(ratio: number, width: number, height: number, maxDimension: number): number;
/** Largest render target this context will allocate, or 0 with no GL context. */
export declare function resolveMaxTextureSize(): number;
export declare function bindDevicePixelScale(value: number): void;
export declare function getDevicePixelScale(): number;
/** CSS pixels to world units. Use for every radius, gap, stroke and offset. */
export declare function u(cssPixels: number): number;
/** CSS pixels to a font-size string. */
export declare function px(cssPixels: number): string;
/**
 ...
 */
export declare function toCssPixels(worldUnits: number): number;
/**
 ...
 */
export declare function scaleLayout<T extends Record<string, unknown>>(layout: T): T;
